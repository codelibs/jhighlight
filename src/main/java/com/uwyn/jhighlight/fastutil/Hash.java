...
public interface Hash {
	 ...
	 * com.uwyn.jhighlight.fastutil.objects.ObjectOpenCustomHashSet}) allow to hash objects
	 * using arbitrary functions, a typical example being that of {@linkplain
	 * com.uwyn.jhighlight.fastutil.ints.IntArrays#HASH_STRATEGY arrays}. Of course,
