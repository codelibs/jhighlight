...
import com.uwyn.jhighlight.fastutil.HashCommon;
import static com.uwyn.jhighlight.fastutil.HashCommon.arraySize;
import static com.uwyn.jhighlight.fastutil.HashCommon.maxFill;
...
import com.uwyn.jhighlight.fastutil.objects.AbstractObjectSet;
...
public class Char2ObjectOpenHashMap <V> extends AbstractChar2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 private int insert(final char k, final V v) {
  ...
  if ( ( (k) == ((char)0) ) ) {
   ...
   // The starting point.
   if ( ! ( (curr = key[ pos = ( com.uwyn.jhighlight.fastutil.HashCommon.mix( (k) ) ) & mask ]) == ((char)0) ) ) {
 ...
 protected final void shiftKeys( int pos ) {
  ...
  for(;;) {
   ...
   for(;;) {
    ...
    slot = ( com.uwyn.jhighlight.fastutil.HashCommon.mix( (curr) ) ) & mask;
 ...
 public V remove( final char k ) {
  ...
  int pos;
  // The starting point.
  if ( ( (curr = key[ pos = ( com.uwyn.jhighlight.fastutil.HashCommon.mix( (k) ) ) & mask ]) == ((char)0) ) ) return defRetValue;
 ...
 public V remove( final Object ok ) {
  ...
  int pos;
  // The starting point.
  if ( ( (curr = key[ pos = ( com.uwyn.jhighlight.fastutil.HashCommon.mix( (k) ) ) & mask ]) == ((char)0) ) ) return (this.defRetValue);
  if ( ( (curr) == (k) ) ) return (removeEntry( pos ));
  while( true ) {
   if ( ( (curr = key[ pos = ( pos + 1 ) & mask ]) == ((char)0) ) ) return (this.defRetValue);
   if ( ( (curr) == (k) ) ) return (removeEntry( pos ));
  }
 }
 public V get( final Character ok ) {
  final char k = ((ok).charValue());
  if ( ( (k) == ((char)0) ) ) return containsNullKey ? (value[ n ]) : (this.defRetValue);
  char curr;
  final char[] key = this.key;
  int pos;
  // The starting point.
 ...
 public boolean containsKey( final char k ) {
  ...
  int pos;
  // The starting point.
  if ( ( (curr = key[ pos = ( com.uwyn.jhighlight.fastutil.HashCommon.mix( (k) ) ) & mask ]) == ((char)0) ) ) return false;
 ...
 public boolean containsValue( final Object v ) {
  ...
  for( int i = n; i-- != 0; ) if ( ! ( (key[ i ]) == ((char)0) ) && ( (value[ i ]) == null ? (v) == null : (value[ i ]).equals(v) ) ) return true;
  return false;
 }
  ...
  public int nextEntry() {
   ...
   for(;;) {
    if ( --pos < 0 ) {
     ...
     int p = ( com.uwyn.jhighlight.fastutil.HashCommon.mix( (k) ) ) & mask;
 ...
 private final class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean contains( final Object o ) {
   ...
   if ( ( (k) == ((char)0) ) ) return ( Char2ObjectOpenHashMap.this.containsNullKey && ( (value[ n ]) == null ? ((e.getValue())) == null : (value[ n ]).equals((e.getValue())) ) );
   char curr;
   final char[] key = Char2ObjectOpenHashMap.this.key;
   int pos;
   // The starting point.
 ...
 protected void rehash( final int newN ) {
  ...
  for( int j = realSize(); j-- != 0; ) {
   while( ( (key[ --i ]) == ((char)0) ) );
   if ( ! ( (newKey[ pos = ( com.uwyn.jhighlight.fastutil.HashCommon.mix( (key[ i ]) ) ) & mask ]) == ((char)0) ) )
 ...
 private void readObject(java.io.ObjectInputStream s) throws java.io.IOException, ClassNotFoundException {
  ...
  for( int i = size, pos; i-- != 0; ) {
   ...
   if ( ( (k) == ((char)0) ) ) {
    ...
    pos = ( com.uwyn.jhighlight.fastutil.HashCommon.mix( (k) ) ) & mask;
