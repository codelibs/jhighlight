 ...
 *
 * <P>Besides extending the corresponding type-specific {@linkplain com.uwyn.jhighlight.fastutil.Function function}, this interface strengthens {@link #entrySet()},
...
public interface Char2ObjectMap <V> extends Char2ObjectFunction <V>, Map<Character,V> {
 ...
 /** Returns a type-specific set view of the mappings contained in this map.
	 ...
	 * so that it returns an {@link com.uwyn.jhighlight.fastutil.objects.ObjectSet}
