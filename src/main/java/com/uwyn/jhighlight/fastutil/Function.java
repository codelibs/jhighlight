 ...
 * for all type-specific maps to extend type-specific functions (e.g., {@link com.uwyn.jhighlight.fastutil.ints.Int2IntMap}
 * extends {@link com.uwyn.jhighlight.fastutil.ints.Int2IntFunction}). However, {@link #size()} is allowed to return -1 to denote
 * that the number of keys is not available (e.g., in the case of a string hash function).
 * 
 * <p>Note that there is an {@link com.uwyn.jhighlight.fastutil.objects.Object2ObjectFunction} that
