 ...
 * <code>com/uwyn/jhighlight/highlighter/XmlHighlighter.flex</code>
 */
public class XmlHighlighter implements ExplicitStateHighlighter {
  ...
  /* user code: */
	...
	/** Style constant {@code PLAIN_STYLE}. */
	public static final byte PLAIN_STYLE = 1;
	/** Style constant {@code CHAR_DATA}. */
	public static final byte CHAR_DATA = 2;
	/** Style constant {@code TAG_SYMBOLS}. */
	public static final byte TAG_SYMBOLS = 3;
	/** Style constant {@code COMMENT}. */
	public static final byte COMMENT = 4;
	/** Style constant {@code ATTRIBUTE_VALUE}. */
	public static final byte ATTRIBUTE_VALUE = 5;
	/** Style constant {@code ATTRIBUTE_NAME}. */
	public static final byte ATTRIBUTE_NAME = 6;
	/** Style constant {@code PROCESSING_INSTRUCTION}. */
	public static final byte PROCESSING_INSTRUCTION = 7;
	/** Style constant {@code TAG_NAME}. */
	public static final byte TAG_NAME = 8;
	/** Style constant {@code RIFE_TAG}. */
	public static final byte RIFE_TAG = 9;
	/** Style constant {@code RIFE_NAME}. */
	public static final byte RIFE_NAME = 10;

	/* Highlighter implementation */
	
	/** Returns the number of styles produced by this highlighter.
	 *
	 * @return the number of styles produced by this highlighter.
	 */
	...
	/** Returns the initial state of this highlighter.
	 *
	 * @return the initial lexical state.
	 */
	...
	/** Returns the current lexical state of this highlighter.
	 *
	...
	/** Sets the current lexical state of this highlighter.
	 *
	...
	/** Creates a new {@link XmlHighlighter}. */
   ...
   *
   * @throws java.io.IOException if an I/O error occurs while closing the input stream.
   */
